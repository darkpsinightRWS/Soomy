  ...
  async function () {
      ...
      Participation.find({ $and: [{ room: room._id }, { flagEmail: false }] })
        ...
        .then(async (data) => {
          ...
          list_participations.forEach((elm) => {
            ...
            var mailOptions = {
              from: "Soomy boubakermeriem62@gmail.com",
              to: list_users,
              subject: "Soomy: Rappel",
                                    ...
                                    <tr>
                                      <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                        ...
                                        <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                          ...
                                          <p style="font-size: 14px; line-height: 160%;"><span style="font-family: Rubik, sans-serif; font-size: 14px; line-height: 22.4px;"><span style="font-size: 18px; line-height: 28.8px;">Ne manquez pas votre enchère qui commencera le 
                                          ${format(
                                      ...
                                      <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                        ...
                                        <div align="center">
                                          ...
                                          <a href="https://soomy.tn/product/${room?._id}" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #f5274c; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                            <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span style="font-size: 16px; line-height: 19.2px;"><strong><span style="line-height: 19.2px; font-size: 16px;">Allez à l'Enchère</span></strong>
                                            </span>
                                            </span>
                                          </a>
                                    ...
                                    <tr>
                                      <td style="overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;font-family:'Cabin',sans-serif;" align="left">
                                        ...
                                        <div style="color: #f5274c; line-height: 160%; text-align: center; word-wrap: break-word;">
                                          ...
                                          <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 16px; line-height: 25.6px; color: #000000;">enchere@soomy.tn</span></p>
                                        </div>
   ...
   `,
                ...
                },
          {
            ...
            path: "../backend/" + room.product?.partner?.image?.imageURL,
          ...
          },
          {
            ...
            path: "../backend/" + room?.product?.image?.imageURL,
            ...
            var transporter = nodemailer.createTransport({
              service: "gmail",
              auth: {
                user: "boubakermeriem62@gmail.com",

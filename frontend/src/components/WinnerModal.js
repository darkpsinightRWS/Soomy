                  ...
                  <div className="col-9 text-center">
                    {props.winner ? (
                      <>
                        ...
                        Vous avez remporté l'enchère suivante. Nous vous invitons a confirmer votre commande, afin
que nous vous livrons le produit.
                        </p>
                        <img
                        ...
                        <div className="col-lg-12 mt-5">
                          ...
                          {props.room?.product?.garantie?<><p className="tag-section-modal">
                            <strong>
                              {" "}
                              {/*  <FontAwesomeIcon
                                            icon={faAward}
...
prochaine fois.Votre crédit de mises vous sera reversé.
                        </p>
                      </>
                    ) : (
                      <>
                      ...
                      { props.winner? <p className="warning-text">
                         L'enchère à été remporté par {props.winner} à {props?.room?.prixPromo} DT
                        </p>:null}
          ...
          {!props.winner?  <Modal.Footer style={{flexWrap:"nowrap"}}>
                <button className="btn btn-outline-cancel w-100" onClick={(e)=>{ 
                  e.preventDefault()
                   setShow(false);
                   props.winnerCallback(show)}}>OK</button>
              </Modal.Footer>:null}
          </form>
        </div>
      </div>

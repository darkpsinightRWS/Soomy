...
></i>
              ...
              <Modal.Body className="py-0">
                ...
                Vous avez connecté a une autre device!
                </h3>
                <p className="warning-text">
                Vous êtes connectés sur un autre appareil, cliquez sur "D'accord" pour quitter la page.
                </p>
                <br />
                <br />
              </Modal.Body>
              <Modal.Footer style={{flexWrap:"nowrap"}}>
                <button className="btn btn-outline-cancel w-100" onClick={()=>navigate('/')}>D'accord</button>
              </Modal.Footer>
            </form>
          </div>
        </div>

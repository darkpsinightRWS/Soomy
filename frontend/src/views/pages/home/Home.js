    ...
    <Container className="p-0" fluid>
      ...
      <main className="container-fluid mx-0 px-0 home-main">
        ...
        <Carousel variant="dark" interval={null} className="home-slide">
            <Carousel.Item>
            <img src={widthInner>991?bgHome:bgHomeMobile} className="d-block w-100" alt="..." />
              <Carousel.Caption>
                <h5>site d'enchère en ligne</h5>
          ...
          <div data-aos-offset="0" data-aos="fade-down" data-aos-once={true} data-aos-duration="1000" data-aos-delay="500" className="instruction-wrapper d-lg-flex flex-column justify-content-center align-items-center d-none ">
            <div className="instructions mx-auto">
              ...
              <div className="d-flex justify-content-evenly">
                ...
                <div className="d-flex flex-column justify-content-center align-items-center">
                  ...
                  <div className="instruction-description">
                    <p className="mx-4">Participez à une enchère en ligne,  </p>
                    <p>et gagnez jusqu'à 50 DT de crédit Bonus. </p>
                  </div>
                </div>
                ...
                <div className="d-flex flex-column justify-content-center align-items-center">
                  ...
                  <div className="instruction-description">
                    <p className="mx-4">À vous de jouer ! il ne vous reste </p>
          ...
          <Accordion className="mt-4 d-lg-none" defaultActiveKey="0">
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body>
                <strong>Inscrivez vous en deux clics sur soomy.tn. C'est gratuit et
rapide à la fois.</strong> 
            ...
            <Accordion.Item eventKey="1">
              ...
              <Accordion.Body>
                <strong>Participez à une enchère en ligne, et gagnez jusqu'à 50
DT de crédit Bonus. </strong>
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="2">
              ...
              <Accordion.Body>
                <strong>Nous vous informons à l'avance,
par un E-mail ou SMS, du démarrage de votre enchère</strong> 
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="3">
              ...
              <Accordion.Body>
                <strong>À vous de jouer! Il ne vous reste qu'à miser et remporter
votre enchère</strong> 
              </Accordion.Body>
            </Accordion.Item>
            <button className="button-detail mx-auto">
            <Link to={"/instructions"}> en savoir plus <i className="fi fi-rr-angle-right"></i> </Link>
            </button>
          </Accordion>
        </section>
        
      {selectedModified?.length>0 ?  <section className="home-section product-section">
          <h1>Nouveautés</h1>
       ...
       { rentableModified?.length>0 ?<section className="home-section product-section">
          <h1>Deals du mois</h1>
          <div className="container" ref={refCarousel}>
          <CarouselMulti
                              swipeable={true}
        ...
        {premiumModified?.length>0 ?<section className="home-section premium-section">
        ...
        <section className="home-section testimonial-section px-lg-5">
          <h1>Communauté soomy</h1>
          <div className="d-flex container flex-wrap">
            <div data-aos="fade-left" data-aos-once={true} data-aos-offset="100" data-aos-duration="1000" data-aos-delay="2000" className="thumb-wrapper box-color ">
              <div className="thumb-content">
                <div className="quote-content">
                  <img src={quote} />
                  <p>
                    Lorem ipsum dolor sit consectetur adipisicing elit. Alias
                    amet deleniti et fugit iusto nesciunt.Lorem ipsum dolor sit
                    consectetur adipisicing elit. Alias amet deleniti et fugit
                    iusto nesciunt.
                  </p>
                </div>
                <div className="testimonial-box">
                  <img className="author-pic" src={avatar} />
                  <h4 className="author-name-box">Foulen Ben Foulen</h4>
                  <p>Position</p>
                </div>
              </div>
            </div>
            <div data-aos="fade-down" data-aos-once={true} data-aos-offset="100" data-aos-duration="1000" data-aos-delay="1500" className="thumb-wrapper box-color ">
              <div className="thumb-content">
                <div className="quote-content">
                  <img src={quote} />
                  <p>
            ...
            <div data-aos="fade-right" data-aos-once={true} data-aos-offset="100" data-aos-duration="1000" data-aos-delay="1000" className="thumb-wrapper box-color ">
              <div className="thumb-content">
                <div className="quote-content">
                  <img src={quote} />
                  <p>

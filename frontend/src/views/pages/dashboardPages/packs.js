  ...
  return (
    <>
          ...
          <div className="d-flex">
            <div className="dashboard-search mx-1">
              ...
              <input
                ...
                onFocus={() => {
                  dispatch(getTotalPacks()).then((res) => setShowSearch(true));
                }}
              />
            </div>
            <button
      ...
      <CTable align="middle" className="mb-0 border" hover responsive>
        ...
        <CTableBody>
          {Packs?.filter((elm) =>
              elm.name.toLowerCase().match(PackSearch?.toLowerCase().trim())
            )
            ?.map((item, index) => (
                  ...
                  <CIcon
                    ...
                    onClick={() => {
                      if (
                        ...
                        dispatch(
                          deletePack({ id: item._id, page: Packs.page })
                        );
                    }}
                  />
                </CTableDataCell>
      ...
      {!showSearch&&Packs&&Packs?.length>0 ? (
         ...
         {Packs?.totalPages > 5 &&
           Packs?.page > 3 && <Pagination.Ellipsis />}
         {Packs?.totalPages === 3 && (
           <Pagination.Item
             onClick={() => {

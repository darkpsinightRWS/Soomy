...
const Login = () => {
  ...
  function sendData(e) {
    e.preventDefault(e);
    dispatch(login(userInput)).then((res) => {
          ...
          <form className="row g-3 mt-3" onSubmit={(e) => sendData(e)}>
            <div className="col-md-12 my-3">
              ...
              <div className="input-group has-validation">
                ...
                >
                  Veuillez saisir un numéro télèphone, E-mail ou Nom d'utilisateur.
                </div>
              </div>
            </div>
            ...
            {loginErrors? <Alert severity="error">
            {loginErrors}
          </Alert>:null}
            ...
            Mot de passe oublié ? 
              <span className="text-primary"> <Link to='/reset' className="psw_reset">Reinitialiser</Link></span>
            </label>
            <label className="mb-1">Vous etes nouveau ici?
              <span className="text-primary">
              <Link to='/register' className="psw_reset"> Créer un compte</Link></span>
            </label>
          </div>

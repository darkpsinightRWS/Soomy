...
export const createParticipation = createAsyncThunk(
  ...
  async (info, { rejectWithValue, dispatch }) => {
    ...
    try {
      const res = await axios.post("/participations/createParticipation",info, {
...
export const deleteTransaction = createAsyncThunk(
  ...
  async (info, { rejectWithValue,dispatch }) => {
    try {
      const res = await axios.delete(`/participations/deletetransaction/${info}`, {
        withCredentials: true,
      });
...
export const updateTransaction = createAsyncThunk(
  ...
  async (info, { rejectWithValue, dispatch }) => {
    try {
      const res = await axios.put(`/participations/updatetransaction/${info.id}`, info.data, {
        withCredentials: true,
      });
      dispatch(fetchTransactionList());
      return res.data;
...
export const fetchTransactionList = createAsyncThunk(
  ...
  async (info, { rejectWithValue }) => {
    try {
      const res = await axios.get(`/participations/getTransactions/${info.page}`, {
        withCredentials: true,
      });
      return res.data;
    } catch (error) {
...
export const fetchUserParticipation = createAsyncThunk(
  ...
  async (info, { rejectWithValue }) => {
    try {
      const res = await axios.get(`/participations/getUserparticipation/${info.id}/${info.room}`, {
        withCredentials: true,
      });
      return res.data;
    } catch (error) {
...
export const getTransactionsbyId = createAsyncThunk(
  ...
  async (info, { rejectWithValue }) => {
    try {
      const res = await axios.post(`/participations/getTransactionsbyId`,info, {
        withCredentials: true,
      });
      return res.data;
    } catch (error) {
...
export const { editTransaction , clearTransactionErrors} = transactionSlice.actions;